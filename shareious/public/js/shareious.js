...
/* ================================================================================================================================================================================================================================================================================
    jQuery plugin used in mobile functionality
================================================================================================================================================================================================================================================================================*/
(function(factory) {
...
================================================================================================================================================================================================================================================================================*/
    ...
    var defaults = {
      ...
      effect : {
       ...
       ignoreImg: {
          img:'.noShareious',
          smallerThanWidth:200,
          smallerThanHeight:200,
      },
      add_delay: false
    }
...
/* ================================================================================================================================================================================================================================================================================
    Options that will be merged with options provided by client
================================================================================================================================================================================================================================================================================*/
...
/* ================================================================================================================================================================================================================================================================================
    Function used to determinate if animation is over
================================================================================================================================================================================================================================================================================*/
...
/* ================================================================================================================================================================================================================================================================================
Result object End Result object End Result object End Result object End Result object End Result object End
================================================================================================================================================================================================================================================================================*/
      result = {
      ...
      loadFacebookOpenGraph : function (fb_app_id){
      ...
      shareData: function(element, network) {
        ...
        summaryObject.media = o.data("media") ? o[0].src : o[0].src;
        ...
        summaryObject.username = opts.username ? opts.username : '';
      ...
      share: function(e, t) {
        ...
        switch (e) {
          ...
          i += "&via=" + encodeURIComponent(t.title);
          break;
          case "tumblr":
      ...
      removeWrapper: function(e, calledFrom){

       if (calledFrom == undefined){

            // remove scrollbar-x until animation is done
           $('body').addClass('overflowOn');
           setTimeout(function(){
               $('body').removeClass('overflowOn');
           }, 650);
           
           $('.shareious div i, .shareioMove').removeClass(opts.effect.in + ' animated').addClass(opts.effect.out + ' animated');
           
           if ( !(opts.effect.in == "noAnimationIn") && $('.shareiousCompact').length) {
           		 $('.shareious > div i').one(animationEvent, function(event) {
	                $('body').removeClass('shareioOn');
	                $('.shareioMove').remove();
	                $('.shareious').removeClass('on').remove();
                });
           }  else if (!(opts.effect.in == "noAnimationIn")) {
           		 $('.shareious > div i').one(animationEvent, function(event) {
	                $('body').removeClass('shareioOn');
	                $('.shareioMove').remove();
	                $('.shareious').removeClass('on').remove();
      ...
      add_wraper: function(e){
         result.removeWrapper(null, 'add_wraper');
         ...
         , append_socials : function(shareious, mobile, src){
                ...
                if (mobile == undefined){
                  $.each(options.socials, function append_soc(key, val){
					if (val == 1){
					  ...
					  var dataNetworkUppercase = capitalize(key);
                      if(key == "vkontakte"){
                          socials_obj += ['<i data-pseudo="vk" data-network="vk" class ="fa draggable fa-vk"></i><i data-network="vk" class="fa droppable fa-vk"/ data-pseudo="vk"  ></i>'];
                      } else if (key == "google") {
                          socials_obj += ['<i data-pseudo="fa-google" data-network="google-plus" class ="fa draggable fa-google"></i><i data-network="google-plus" class="fa droppable fa-google" data-pseudo="google"></i>'];
                      } else {
                          socials_obj += ['<i data-pseudo="'+dataNetworkUppercase+'" data-network="'+key+'" class ="fa draggable fa-'+key+'"></i><i data-network="'+key+'" class="fa droppable fa-'+key+'"/ data-pseudo="'+dataNetworkUppercase+'" ></i>'];
                      } } 
                 });
                 ...
                 $.each(options.socials, function append_soc(key, val){
                 	if (val == 1){
                 	    var dataNetworkUppercase = capitalize(key);
                     if(key == "vkontakte"){
                         socials_obj += ['<i data-pseudo="vk" data-network="vk" class ="fa draggable fa-vk" data-pseudo="vk"  ></i>'];
                     } else if (key == "google") {
                         socials_obj += ['<i data-pseudo="google" data-network="google-plus" class ="fa draggable fa-google" data-pseudo="google"  ></i>'];
                     } else {
                         socials_obj += ['<i data-pseudo="'+dataNetworkUppercase+'" data-network="'+key+'" class ="fa draggable fa-'+key+'" data-pseudo="'+dataNetworkUppercase+'" ></i>'];
                     }}
                });
             ...
             ********************************************************************************************************************************************/
                ...
                $.each(defaults.socials, function append_soc(key, val){
                    var dataNetworkUppercase = capitalize(key);
                    if(key == "vkontakte"){
                        socials_obj += ['<i data-pseudo="fa-vk" data-network="vk" class ="fa draggable fa-vk"></i><i data-network="vk" class="fa droppable fa-vk" data-pseudo="fa-vk"  ></i>'];
                    } else if (key == "google") {
                        socials_obj += ['<i data-pseudo="fa-google" class ="fa draggable fa-google"></i><i data-network="google-plus" class="fa droppable fa-google" data-pseudo="fa-google"  ></i>'];
                    } else {
                        socials_obj += ['<i data-pseudo="'+dataNetworkUppercase+'" data-network="'+key+'" class ="fa draggable fa-'+key+'"></i><i data-network="'+key+'" class="fa droppable fa-'+key+'"/ data-pseudo="'+dataNetworkUppercase+'" ></i>'];
                    }
                 ...
                 $.each(defaults.socials, function append_soc(key, val){
                    var dataNetworkUppercase = capitalize(key);
                     if(key == "vkontakte"){
                         ...
                         socials_obj += ['<i data-pseudo="google" data-network="google-plus" class ="fa draggable fa-google-plus" data-pseudo="google"  ></i>'];
                     } else {
                         socials_obj += ['<i data-pseudo="'+dataNetworkUppercase+'" data-network="'+key+'" class ="fa draggable fa-'+key+'" data-pseudo="'+dataNetworkUppercase+'" ></i>'];
                     }
       ...
       wrapSocials : function(e, argument){
        ...
        setWidth : function(e) {
           var i_length = e.find('div:first i').length,width,
            ...
            if( !(shareiousImgWidth <= opts.ignoreImg.smallerThanWidth) && !(shareiousImgHeight <= opts.ignoreImg.smallerThanHeight)){
                if(shareiousIWidth > 42 && opts.shareiousCompact == 0){
                    ...
                    (options.click == 1) ? click_events() : drag_events();
        ...
        shareioCompact: function(){
                    ...
                    $shareCompact.addClass('shareiousCompact');
                    $shareCompact.after('<p style="background:'+ opts.shareCompactColor +';  top:'+ (shareioComCoord[1] + shareioComCoord[2] - 18) + 'px; left:'+(shareioComCoord[0] + shareioComCoord[4])+'px" class="'+opts.effect.in+' animated fa fa-share-alt shareioMove"></p>');
                    $('.shareioMove').draggable({ 
                    ...
                    $shareCompact.find('i.droppable').droppable({
                        tolerance: "fit",
                        over: function (event, ui) {
                    ...
                    $(document).off('drop', '.shareiousCompact i.droppable');
                    $(document).on('drop', '.shareiousCompact i.droppable',  function(event, ui) {
                          var item_selected;
...
================================================================================================================================================================================================================================================================================*/
      ...
      var hovered = false ;
      function removeClasses(argument){
              $('.shareious').removeClass('dragEvents');
...
=============================================================================================================================================================================================================*/
    function drag_events(){
        //add custom class for drag to share
        $('.shareious').addClass('dragEvents');
